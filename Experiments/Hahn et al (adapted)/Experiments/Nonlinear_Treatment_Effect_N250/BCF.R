...
column_means[3] <- X_full$x3[j]
column_means[4] <- X_full$x4[j]
column_means[5] <- X_full$x5[j]
column_means[6] <- X_full$pi_hats[j]
D_range <- seq(0.01, max_D, length.out = number_of_points)
